...
.panel{padding:54px 48px}.panel h2{font-size:25px;margin:0 0 7px}.subtitle{color:var(--muted);font-size:14px;margin:0 0 26px}.roles{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:22px}.role{border:1px solid var(--line);border-radius:12px;padding:13px 12px;text-decoration:none;color:var(--muted);font-weight:700;text-align:center;font-size:14px}.role.active{background:#eaf4ee;color:var(--green);border-color:#9cc5ae;box-shadow:inset 0 0 0 1px #9cc5ae}
...
@media(max-width:760px){body{padding:14px}.shell{grid-template-columns:1fr;border-radius:18px}.intro{padding:30px}.intro h1{font-size:26px}.logo{margin-bottom:25px;width:175px}.steps{display:none}.panel{padding:32px 26px}}
</style>
</head>
<body>
<main class="shell">
